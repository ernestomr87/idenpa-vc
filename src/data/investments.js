export default [
	...
	},
	{
		...
		json:
			'http://geoservicios.enpa.vcl.minag.cu/geoserver/ws_ide_vcl/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=ws_ide_vcl:entidad&maxFeatures=50&outputFormat=application%2Fjson'
	}
];
